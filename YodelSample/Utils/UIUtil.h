...
extern NSString *const TEXT_CELL_IDENTIFIER;
extern const CGFloat TEXT_CELL_HEIGHT;

@interface UIUtil : NSObject

extern const CGFloat IMAGE_ASPECT_RATIO;

@property(readonly, nonatomic, strong) CAGradientLayer *searchBarGradient;
